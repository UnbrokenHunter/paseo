...
export const ko: TranslationResources = {
  ...
  agentStream: {
    ...
    stickyHeader: {
      userAccessibilityLabel: "마지막 사용자 프롬프트로 이동: {{preview}}",
      assistantAccessibilityLabel: "마지막 AI 응답으로 이동: {{preview}}",
    },
    messageCollapse: {
      collapseUser: "이 프롬프트 접기",
      collapseAssistant: "이 응답 접기",
      expandUser: "이 프롬프트 펼치기",
      expandAssistant: "이 응답 펼치기",
    },
  ...
  providerUsage: {
    ...
    refreshFailedTitle: "마지막으로 확인된 사용량을 표시합니다",
    ...
    retry: "다시 시도",
    tooltipLoading: "플랜 사용량을 불러오는 중…",
    compact: {
      remaining: "{{percent}}% 남음",
      remainingWithReset: "{{percent}}% 남음 · {{duration}} 후 초기화",
    },
    states: {
      unavailable: "사용량을 확인할 수 없음",
      unavailableExplanation: "이 프로바이더는 사용량 한도를 보고하지 않습니다.",
      loading: "사용량을 불러오는 중…",
      retry: "다시 시도",
      failed: "사용량을 불러올 수 없습니다",
      unmetered: "사용량 한도 없음",
      unmeteredExplanation: "이 모델은 사용자의 컴퓨터에서 제공되므로 보고할 할당량이 없습니다.",
    },
    card: {
      statusError: "오류",
  ...
  settings: {
    ...
    general: {
      ...
      providerUsageRotation: {
        label: "프로바이더 사용량 한도 순환",
        description:
          "표시기에서 모든 사용량 한도를 순환합니다. 끄면 소진에 가장 가까운 한도만 표시됩니다.",
      },
      stickyConversationHeader: {
        label: "대화 헤더 고정",
        description: "스크롤하는 동안 마지막 프롬프트와 응답을 계속 표시합니다",
        accessibilityLabel: "대화 헤더 고정 선택({{value}})",
        options: {
          off: "끄기",
          user: "사용자 프롬프트만",
          userAndAi: "사용자 + AI",
    ...
    providers: {
      ...
      account: {
        ...
        warnings: {
          renameUnsupported:
            "이 호스트는 기존 채팅을 새 ID로 옮길 수 없습니다. 호스트를 업데이트하거나 이전 ID를 복원할 때까지 이 계정을 사용하는 채팅은 사용할 수 없습니다.",
        },
        errors: {
