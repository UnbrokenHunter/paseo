...
export const ru: TranslationResources = {
  ...
  modelSelector: {
    ...
    access: "Доступ",
    accessCount: "{{count}} аккаунт",
    accessCountPlural: "{{count}} аккаунтов",
    retry: "Повторить попытку",
  ...
  settings: {
    ...
    agentRuntimes: {
      ...
      modelRouting: {
        ...
        description:
          "Начните с любого параметра. Остальные сузятся до того, что этот хост действительно может запустить.",
        selectModel: "Выбрать модель",
        noOptions: "Нет вариантов, совместимых с текущим выбором.",
        noRoutes:
          "Пока нет доступных для маршрутизации моделей. Среды выполнения сообщают о моделях после первой загрузки каталога.",
        resolved: "Запустит {{binding}} · {{model}}",
        incomplete: "Продолжайте выбирать, чтобы остался один запускаемый маршрут",
        facets: {
          family: "Семейство",
          access: "Доступ",
          model: "Модель",
