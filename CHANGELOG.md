...
- Korean UI localization ([#2895](https://github.com/getpaseo/paseo/pull/2895))
...
- OpenCode subagents show their task, type, model, and token use ([#2909](https://github.com/getpaseo/paseo/pull/2909))
...
- Claude reports a dead runtime instead of sitting idle ([#2910](https://github.com/getpaseo/paseo/pull/2910))
...
- Desktop browser tabs stay stable across focus changes and automation ([#2907](https://github.com/getpaseo/paseo/pull/2907))
...
- Voice capture releases the audio session when it goes idle ([#2866](https://github.com/getpaseo/paseo/pull/2866))
...
- Active host connection choices survive a reconnect ([#2905](https://github.com/getpaseo/paseo/pull/2905))
...
- Workspace suggestions skip Git-ignored paths ([#2902](https://github.com/getpaseo/paseo/pull/2902))
